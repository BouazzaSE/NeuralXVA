# NeuralXVA
NeuralXVA is a simulation code written for the paper **"Hierarchical Simulation for Learning With Defaults"** by Abbas-Turki Lokman, Crépey Stéphane and Saadeddine Bouazza (see citation below, pre-print available at pre-print: https://www.lpsm.paris/pageperso/crepey/papers/LEARNING_FROM_DEFAULTS.pdf). It implements:
